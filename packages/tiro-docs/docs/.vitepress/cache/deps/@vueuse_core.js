...
// ../../node_modules/.pnpm/@vueuse+shared@9.3.1/node_modules/@vueuse/shared/index.mjs
...
// ../../node_modules/.pnpm/@vueuse+core@9.3.1/node_modules/@vueuse/core/index.mjs
  ...
  const cleanup = [
    ...
    useEventListener(
      ...
      (e) => {
        const el = unrefElement(target)
        shouldListen.value =
          !!el && !e.composedPath().includes(el) && !shouldIgnore(e)
      },
      { passive: true }
    ),
    useEventListener(
...
function useTimeAgo(time, options = {}) {
  ...
  const timeAgo = computed(() =>
    getTimeago(new Date(resolveUnref(time)), unref(now2.value))
  )
  if (exposeControls) {
